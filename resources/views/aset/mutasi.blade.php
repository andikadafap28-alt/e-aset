...
<div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
    ...
    <a href="{{ route('aset.mutasi.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center gap-2">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="py-3 px-5">
                        <a href="{{ route('aset.show', $mutasi->asset_id) }}" class="font-medium text-teal-600 hover:text-indigo-800">{{ $mutasi->asset->name }}</a>
