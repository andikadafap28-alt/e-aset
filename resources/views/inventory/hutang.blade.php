                ...
                <tbody class="text-sm divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-right">
                            <button @click="showModal = true; selectedId = {{ $trx->id }}" class="bg-teal-50 hover:bg-teal-50 text-teal-600 font-medium px-4 py-2 rounded-lg transition-colors text-xs border border-indigo-200">
                                Ubah ke SPJ
                            </button>
                        </td>
                    </tr>
        ...
        <div @click.away="showModal = false" class="relative w-full max-w-md p-4 bg-white rounded-2xl shadow-xl transform transition-all">
            ...
            <form :action="'/{{ $kategori_besar }}/hutang/' + selectedId + '/spj'" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="date" name="tanggal_spj" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all font-medium text-slate-700">
                </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium py-2 px-5 rounded-lg shadow-sm shadow-indigo-600/20 transition-all">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
