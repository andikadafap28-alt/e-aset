            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <input type="month" name="bulan_awal" required class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                            <span class="text-slate-400 font-medium">s/d</span>
                            <input type="month" name="bulan_akhir" required class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="space-y-3">
                            <label class="flex items-start gap-3 p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50/50">
                                <input type="radio" name="jenis_laporan" value="internal" checked class="mt-1 text-indigo-600 focus:ring-indigo-500">
                                <div>
                            ...
                            <label class="flex items-start gap-3 p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50/50">
                                <input type="radio" name="jenis_laporan" value="dinas" class="mt-1 text-indigo-600 focus:ring-indigo-500">
                                <div>
