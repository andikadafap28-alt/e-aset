        ...
        <form action="{{ route('settings.update') }}" method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <div class="relative max-w-md">
                    <input type="text" id="public_asset_password" name="public_asset_password" value="{{ old('public_asset_password', $password) }}" class="w-full rounded-lg border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm pl-10" required minlength="4">
            ...
            <div class="pt-4 border-t border-slate-100 flex justify-end">
                <button type="submit" class="bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-6 rounded-lg shadow-sm transition-colors flex items-center gap-2">
